...
import 'package:chatterbox_firebase/screens/ChatScreen.dart';
      ...
      trailing: InkWell(
        onTap:() async{
          ...
          if(isJoined){
            ...
            showSnackBar(context, Colors.red, "Succesfully Joined the group");
            Future.delayed(const Duration(seconds: 2), (){
              nextScreen(context, ChatScreen(groupId: groupId, groupName: groupName, userName: userName));
            });
          } else{
            setState(() {
              isJoined = !isJoined;
